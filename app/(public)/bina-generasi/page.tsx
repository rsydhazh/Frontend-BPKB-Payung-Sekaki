...
export default function BinaGenerasiPage() {
  return (
      ...
      <section className="relative w-full h-[60vh] flex items-center overflow-hidden rounded-b-[4rem] shadow-[0_15px_40px_rgba(10,22,128,0.2)]">
        ...
        <div className="relative z-10 px-8 lg:px-16 max-w-4xl mt-10">
          ...
          <p className="text-[#93b2f8] text-lg lg:text-xl font-medium leading-relaxed max-w-2xl">
            Pusat informasi dan dokumentasi program pembinaan keluarga balita (BKB) dan keluarga lansia (BKL) di Payung Sekaki.
          </p>
        </div>
      </section>

      {/* 2. GRID KARTU (Dinaikkan menimpa hero section) */}
      <div className="max-w-7xl mx-auto px-8 lg:px-16 -mt-10 relative z-20">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-10 rounded-4xl shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-gray-100 hover:shadow-[0_20px_40px_rgba(10,22,128,0.08)] hover:-translate-y-2 transition-all duration-300 group flex flex-col">
            ...
            <h2 className="text-2xl font-extrabold text-[#1a1a1a] mb-4">Bina Keluarga Balita (BKB)</h2>
            <p className="text-gray-500 leading-relaxed mb-8 flex-1">
              Fokus pada pembinaan orang tua dalam pola asuh dan tumbuh kembang anak balita yang sehat.
            </p>
            <Link href="/bina-generasi/bkb" className="flex items-center gap-2 text-[#f1b94c] font-bold text-sm uppercase tracking-wider group-hover:text-[#0a1680] transition-colors mt-auto w-fit">
          ...
          <div className="bg-white p-10 rounded-4xl shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-gray-100 hover:shadow-[0_20px_40px_rgba(10,22,128,0.08)] hover:-translate-y-2 transition-all duration-300 group flex flex-col">
            ...
            <h2 className="text-2xl font-extrabold text-[#1a1a1a] mb-4">Bina Keluarga Lansia (BKL)</h2>
            <p className="text-gray-500 leading-relaxed mb-8 flex-1">
              Meningkatkan kesejahteraan, kesehatan, dan produktivitas lansia agar tetap tangguh di usia senja.
            </p>
            <Link href="/bina-generasi/bkl" className="flex items-center gap-2 text-[#0a1680] font-bold text-sm uppercase tracking-wider group-hover:text-[#f1b94c] transition-colors mt-auto w-fit">
              Pelajari <FiArrowRight className="group-hover:translate-x-1 transition-transform" />
            </Link>
          </div>
