        ...
        {beritaData.length === 0 ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {beritaData.map((berita) => (
              <Link href={`/keluarga/berita/${berita.id}`} key={berita.id} className="group bg-white rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgba(10,22,128,0.12)] border border-gray-100 flex flex-col overflow-hidden transform hover:-translate-y-2 transition-all duration-300">
