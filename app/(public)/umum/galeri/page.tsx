    ...
    <main className="bg-[#fcfdff] min-h-screen pb-24 font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-16 -mt-20 relative z-20">
        {gallery.length === 0 ? (
          ...
          /* EMPTY STATE (Disamakan dengan Kependudukan) */
          ...
          /* GRID GAMBAR (Gaya Mewah Kependudukan) */
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {gallery.map((item, idx) => (
              <div key={idx} className="group relative h-80 rounded-3xl overflow-hidden shadow-md cursor-pointer border-4 border-white">
